<div class="slide-home slide-home-1" data-img="<?php echo $projData['homeUrl'] ?>/wp-content/uploads/2017/07/bg-1.jpg" style="background: url(<?php echo $projData['homeUrl'] ?>/wp-content/uploads/2017/07/bg-1.jpg) center center; background-size: cover;">
	<div class="blck-inn">
		<h1>El intercambio</h1>	
